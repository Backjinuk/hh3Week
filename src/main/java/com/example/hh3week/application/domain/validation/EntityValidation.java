package com.example.hh3week.application.domain.validation;
...
import com.example.hh3week.application.domain.user.entity.User;
import com.example.hh3week.application.domain.user.entity.UserPointHistory;
